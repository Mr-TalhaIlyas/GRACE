...
eval_config = {
    ...
    'pickel_file': 'seizeit2_results.pkl',
    'output_dir': '/home/user01/Data/npj/output/seizeit2/'
}
...
ecg = shift_down(seizeit2_targets_collected, ecg, shift=1.25)
...
ecgH_alfred = shift_up(seizeit2_targets_collected, ecgH_alfred, shift=1.4)
ecgH_alfred = apply_temporal_smoothing_probs(ecgH_alfred, 3)

fusion_ecgH_probs = fusion_hrv_probs['ecg_outputs']
fusion_ecgH_probs = shift_up(seizeit2_targets_collected, fusion_ecgH_probs, shift=1.5)
fusion_ecgH_probs = apply_temporal_smoothing_probs(fusion_ecgH_probs, 5)

_ = draw_temporal_seizure_plots(seizeit2_targets_collected, #<- human expert labels
                                probs_list=[eeg,
                                            fusion_ecgH_probs, 
                                            ecgH, ecg,
