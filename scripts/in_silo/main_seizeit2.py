...
#%%
exp_name = 'seizeIT2_eeg_bvg_InceptionTimexx' 
# Define your configuration for wandb
config = {
    'batch_size_train': 8,#64, 8 
    'batch_size_valid': 8,#128, 16
    'lr_max': 1e-5,
    'epochs': 100,
    'architecture': 'InceptionTime',
    'data_dir': '/home/user01/Data/npj/datasets/seizeit2/ts_analysis/',
...
# Load your data
data = joblib.load(f'{config["data_dir"]}SeizeIT2_ecgH_full_w10_o5.joblib')
...
y_test = data['test_label'] + 1 # to make it 0 based
...
model = InceptionTime(dls.vars, dls.c, fc_dropout=.0, nf=64, return_features=False)
